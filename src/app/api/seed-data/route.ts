...
export async function POST(request: NextRequest) {
  try {
    ...
    // ============================================================
    // ARTICLE_MASTER (65+ articles — mapclub.com format with size variants)
    // ============================================================

    // Product group definitions — each group expands into multiple size-variant articles
    const articleProductGroups = [
      // ── FOOTWEAR / RUNNING_SHOES ────────────────────────────────────────
      {
        genericArticleCode: 'SP260407414929-A048',
        productName: "Nike Pegasus 42 Women's Road Running Shoes",
        description: "Nike Pegasus 42 Women's Road Running Shoes — responsive ZoomX cushioning for daily training, lightweight mesh upper with breathable support, Coral colorway",
        brand: 'Nike', category: 'FOOTWEAR', subCategory: 'RUNNING_SHOES',
        color: 'Coral', colorCode: 'COR',
        imageUrl: 'https://picsum.photos/seed/nike-pegasus42-coral/600/600',
        sourceUrl: 'https://www.mapclub.com/item/planet-sports/nike/nike-pegasus-42-women-s-road-running-shoes-coral-SP260407414929-A048',
        purchasePrice: 1200000, sellingPrice: 1899000, retailer: 'Planet Sports', tags: 'NEW_ARRIVAL,BEST_SELLER',
        sizes: [{ size: '38', sizeCode: '38' }, { size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'ACTIVE', companyCode: 'MAPA',
      },
      {
        genericArticleCode: 'SP260407414930-A049',
        productName: 'Nike Air Max 90',
        description: 'Nike Air Max 90 — iconic silhouette with visible Air cushioning, premium leather and mesh upper, durable rubber waffle outsole',
        brand: 'Nike', category: 'FOOTWEAR', subCategory: 'CASUAL_SNEAKERS',
        color: 'White/Red', colorCode: 'WHTRED',
        imageUrl: 'https://picsum.photos/seed/nike-airmax90-whtrd/600/600',
        sourceUrl: 'https://www.mapclub.com/item/planet-sports/nike/nike-air-max-90-white-red-SP260407414930-A049',
        purchasePrice: 1100000, sellingPrice: 1799000, retailer: 'Planet Sports', tags: 'BEST_SELLER,PREMIUM',
        sizes: [{ size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }, { size: '42', sizeCode: '42' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      {
        genericArticleCode: 'SP260407414931-A050',
        productName: "Nike Air Force 1 Low '07",
        description: "Nike Air Force 1 Low '07 — the essential white sneaker, full-grain leather upper, Air-Sole unit for lightweight cushioning, pivot-point outsole",
        brand: 'Nike', category: 'FOOTWEAR', subCategory: 'CASUAL_SNEAKERS',
        color: 'White', colorCode: 'WHT',
        imageUrl: 'https://picsum.photos/seed/nike-af1-white/600/600',
        sourceUrl: 'https://www.mapclub.com/item/nike-store/nike/nike-air-force-1-low-07-white-SP260407414931-A050',
        purchasePrice: 750000, sellingPrice: 1299000, retailer: 'Nike Store', tags: 'BEST_SELLER',
        sizes: [{ size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }, { size: '42', sizeCode: '42' }],
        status: 'ACTIVE', companyCode: 'MAPA',
      },
      {
        genericArticleCode: 'SP260407414932-A051',
        productName: 'Nike Dunk Low Retro',
        description: 'Nike Dunk Low Retro — classic basketball-turned-lifestyle sneaker, padded collar for comfort, durable rubber outsole with pivot pattern',
        brand: 'Nike', category: 'FOOTWEAR', subCategory: 'CASUAL_SNEAKERS',
        color: 'White/Black', colorCode: 'WHTBLK',
        imageUrl: 'https://picsum.photos/seed/nike-dunklow-panda/600/600',
        sourceUrl: 'https://www.mapclub.com/item/planet-sports/nike/nike-dunk-low-retro-white-black-SP260407414932-A051',
        purchasePrice: 980000, sellingPrice: 1599000, retailer: 'Planet Sports', tags: 'NEW_ARRIVAL,BEST_SELLER',
        sizes: [{ size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      {
        genericArticleCode: 'SP260407414933-A052',
        productName: 'Nike Air Jordan 1 Retro High OG',
        description: 'Air Jordan 1 Retro High OG — the icon that started it all, premium leather upper, Air-Sole unit encapsulated in heel, rubber cupsole with pivot pattern',
        brand: 'Nike', category: 'FOOTWEAR', subCategory: 'BASKETBALL_SHOES',
        color: 'Black/Varsity Red', colorCode: 'BLKRED',
        imageUrl: 'https://picsum.photos/seed/jordan1-retro-high/600/600',
        sourceUrl: 'https://www.mapclub.com/item/planet-sports/nike/nike-air-jordan-1-retro-high-og-black-red-SP260407414933-A052',
        purchasePrice: 2500000, sellingPrice: 3899000, retailer: 'Planet Sports', tags: 'EXCLUSIVE,PREMIUM',
        sizes: [{ size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }, { size: '42', sizeCode: '42' }],
        status: 'ACTIVE', companyCode: 'MAPA',
      },
      {
        genericArticleCode: 'SP260407414934-A053',
        productName: 'Nike Air Max Alpha Trainer 6',
        description: 'Nike Air Max Alpha Trainer 6 — versatile training shoe with Max Air cushioning, wide flat base for stability, mesh upper for breathability',
        brand: 'Nike', category: 'FOOTWEAR', subCategory: 'TRAINING_SHOES',
        color: 'Black', colorCode: 'BLK',
        imageUrl: 'https://picsum.photos/seed/nike-alpha-trainer6/600/600',
        sourceUrl: 'https://www.mapclub.com/item/planet-sports/nike/nike-air-max-alpha-trainer-6-black-SP260407414934-A053',
        purchasePrice: 850000, sellingPrice: 1399000, retailer: 'Planet Sports', tags: 'BEST_SELLER',
        sizes: [{ size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }, { size: '42', sizeCode: '42' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      {
        genericArticleCode: 'SP260407414935-A054',
        productName: 'Nike Victori One Slide',
        description: 'Nike Victori One Slide — lightweight recovery slide with soft foam, contoured footbed, flexible groove pattern for natural motion',
        brand: 'Nike', category: 'FOOTWEAR', subCategory: 'SLIDES',
        color: 'Black/White', colorCode: 'BLKWHT',
        imageUrl: 'https://picsum.photos/seed/nike-victori-slide/600/600',
        sourceUrl: 'https://www.mapclub.com/item/nike-store/nike/nike-victori-one-slide-black-white-SP260407414935-A054',
        purchasePrice: 250000, sellingPrice: 449000, retailer: 'Nike Store', tags: 'BEST_SELLER',
        sizes: [{ size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── FOOTWEAR / Adidas ────────────────────────────────────────────────
      {
        genericArticleCode: 'SP260507414929-A055',
        productName: 'Adidas Ultraboost Light',
        description: 'Adidas Ultraboost Light — the lightest BOOST midsole ever created, Primeknit+ upper for adaptive support, Continental rubber outsole for grip',
        brand: 'Adidas', category: 'FOOTWEAR', subCategory: 'RUNNING_SHOES',
        color: 'Cloud White/Core Black', colorCode: 'CWHBLK',
        imageUrl: 'https://picsum.photos/seed/adidas-ultraboost-light/600/600',
        sourceUrl: 'https://www.mapclub.com/item/adidas-originals/adidas/adidas-ultraboost-light-cloud-white-SP260507414929-A055',
        purchasePrice: 2200000, sellingPrice: 3299000, retailer: 'Adidas Originals', tags: 'NEW_ARRIVAL,PREMIUM',
        sizes: [{ size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }, { size: '42', sizeCode: '42' }, { size: '43', sizeCode: '43' }],
        status: 'ACTIVE', companyCode: 'MAPA',
      },
      {
        genericArticleCode: 'SP260507414930-A056',
        productName: 'Adidas Stan Smith',
        description: 'Adidas Stan Smith — the classic white tennis shoe since 1971, smooth leather upper, signature perforated 3-Stripes, cupsole construction',
        brand: 'Adidas', category: 'FOOTWEAR', subCategory: 'CASUAL_SNEAKERS',
        color: 'White/Green', colorCode: 'WHTGRN',
        imageUrl: 'https://picsum.photos/seed/adidas-stan-smith/600/600',
        sourceUrl: 'https://www.mapclub.com/item/adidas-originals/adidas/adidas-stan-smith-white-green-SP260507414930-A056',
        purchasePrice: 650000, sellingPrice: 1099000, retailer: 'Adidas Originals', tags: 'BEST_SELLER',
        sizes: [{ size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      {
        genericArticleCode: 'SP260507414931-A057',
        productName: 'Adidas NMD R1',
        description: 'Adidas NMD R1 — progressive design meets BOOST comfort, stretchy knit upper, full-length BOOST midsole, EVA midsole plugs',
        brand: 'Adidas', category: 'FOOTWEAR', subCategory: 'CASUAL_SNEAKERS',
        color: 'Core Black', colorCode: 'CB',
        imageUrl: 'https://picsum.photos/seed/adidas-nmd-r1-blk/600/600',
        sourceUrl: 'https://www.mapclub.com/item/adidas-originals/adidas/adidas-nmd-r1-core-black-SP260507414931-A057',
        purchasePrice: 1200000, sellingPrice: 1999000, retailer: 'Adidas Originals', tags: 'FEATURED',
        sizes: [{ size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      {
        genericArticleCode: 'SP260507414932-A058',
        productName: 'Adidas Superstar',
        description: 'Adidas Superstar — the shell toe icon since 1969, smooth leather upper, iconic rubber shell toe, herringbone-pattern cupsole',
        brand: 'Adidas', category: 'FOOTWEAR', subCategory: 'CASUAL_SNEAKERS',
        color: 'White/Black', colorCode: 'WHTBLK',
        imageUrl: 'https://picsum.photos/seed/adidas-superstar/600/600',
        sourceUrl: 'https://www.mapclub.com/item/adidas-originals/adidas/adidas-superstar-white-black-SP260507414932-A058',
        purchasePrice: 550000, sellingPrice: 999000, retailer: 'Adidas Originals', tags: 'BEST_SELLER',
        sizes: [{ size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'ACTIVE', companyCode: 'MAPA',
      },
      // ── FOOTWEAR / Puma ──────────────────────────────────────────────────
      {
        genericArticleCode: 'SP260607414929-A059',
        productName: 'Puma RS-X Reinvention',
        description: 'Puma RS-X Reinvention — bold chunky design with RS technology, mesh and leather upper, ProFoam cushioning, rubber outsole',
        brand: 'Puma', category: 'FOOTWEAR', subCategory: 'CASUAL_SNEAKERS',
        color: 'Puma White/Royal Blue', colorCode: 'PWRRBL',
        imageUrl: 'https://picsum.photos/seed/puma-rsx-reinvention/600/600',
        sourceUrl: 'https://www.mapclub.com/item/puma-store/puma/puma-rs-x-reinvention-white-royal-blue-SP260607414929-A059',
        purchasePrice: 900000, sellingPrice: 1499000, retailer: 'Puma Store', tags: 'NEW_ARRIVAL',
        sizes: [{ size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      {
        genericArticleCode: 'SP260607414930-A060',
        productName: 'Puma Suede Classic XXI',
        description: 'Puma Suede Classic XXI — the B-Boy icon since 1968, premium suede upper, rubber outsole with formstrip, rounded laces',
        brand: 'Puma', category: 'FOOTWEAR', subCategory: 'CASUAL_SNEAKERS',
        color: 'Puma Black', colorCode: 'PB',
        imageUrl: 'https://picsum.photos/seed/puma-suede-classic/600/600',
        sourceUrl: 'https://www.mapclub.com/item/puma-store/puma/puma-suede-classic-xxi-black-SP260607414930-A060',
        purchasePrice: 500000, sellingPrice: 899000, retailer: 'Puma Store', tags: 'BEST_SELLER',
        sizes: [{ size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      {
        genericArticleCode: 'SP260607414931-A061',
        productName: 'Puma x AMI Suede XL',
        description: 'Puma x AMI Suede XL — the Parisian collab on the classic silhouette, premium suede, co-branded detailing, limited edition release',
        brand: 'Puma', category: 'FOOTWEAR', subCategory: 'CASUAL_SNEAKERS',
        color: 'Puma Black/AMI Red', colorCode: 'PBAMR',
        imageUrl: 'https://picsum.photos/seed/puma-ami-suedexl/600/600',
        sourceUrl: 'https://www.mapclub.com/item/puma-store/puma/puma-x-ami-suede-xl-black-red-SP260607414931-A061',
        purchasePrice: 1500000, sellingPrice: 2499000, retailer: 'Puma Store', tags: 'LIMITED,EXCLUSIVE',
        sizes: [{ size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'DRAFT', companyCode: 'MAPI',
      },
      // ── FOOTWEAR / Converse ──────────────────────────────────────────────
      {
        genericArticleCode: 'SP260707414929-A062',
        productName: 'Converse Chuck Taylor All Star High',
        description: 'Converse Chuck Taylor All Star High — the most iconic sneaker of all time, canvas upper, rubber toe cap, ortholite insole',
        brand: 'Converse', category: 'FOOTWEAR', subCategory: 'CASUAL_SNEAKERS',
        color: 'Black', colorCode: 'BLK',
        imageUrl: 'https://picsum.photos/seed/converse-chuck-high/600/600',
        sourceUrl: 'https://www.mapclub.com/item/converse-store/converse/converse-chuck-taylor-all-star-high-black-SP260707414929-A062',
        purchasePrice: 450000, sellingPrice: 799000, retailer: 'Converse Store', tags: 'BEST_SELLER',
        sizes: [{ size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── FOOTWEAR / Vans ──────────────────────────────────────────────────
      {
        genericArticleCode: 'SP260807414929-A063',
        productName: 'Vans Old Skool',
        description: 'Vans Old Skool — the classic side stripe skate shoe, canvas and suede upper, vulcanized rubber waffle outsole, padded collar',
        brand: 'Vans', category: 'FOOTWEAR', subCategory: 'CASUAL_SNEAKERS',
        color: 'Black/White', colorCode: 'BLKWHT',
        imageUrl: 'https://picsum.photos/seed/vans-old-skool/600/600',
        sourceUrl: 'https://www.mapclub.com/item/vans-store/vans/vans-old-skool-black-white-SP260807414929-A063',
        purchasePrice: 400000, sellingPrice: 749000, retailer: 'Vans Store', tags: 'BEST_SELLER',
        sizes: [{ size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── FOOTWEAR / Under Armour ──────────────────────────────────────────
      {
        genericArticleCode: 'SP260907414929-A064',
        productName: 'Under Armour Curry 10',
        description: 'UA Curry 10 — Stephen Curry signature basketball shoe with UA Flow cushioning, Warp upper for locked-in fit, herringbone traction',
        brand: 'Under Armour', category: 'FOOTWEAR', subCategory: 'BASKETBALL_SHOES',
        color: 'White/Gold', colorCode: 'WHTGLD',
        imageUrl: 'https://picsum.photos/seed/ua-curry10/600/600',
        sourceUrl: 'https://www.mapclub.com/item/under-armour-store/under-armour/ua-curry-10-white-gold-SP260907414929-A064',
        purchasePrice: 2100000, sellingPrice: 3299000, retailer: 'Under Armour Store', tags: 'NEW_ARRIVAL,PREMIUM',
        sizes: [{ size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }, { size: '42', sizeCode: '42' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── FOOTWEAR / ASICS ─────────────────────────────────────────────────
      {
        genericArticleCode: 'SP261007414929-A065',
        productName: 'ASICS Gel-Kayano 30',
        description: 'ASICS Gel-Kayano 30 — stability running icon with FF Blast+ cushioning, 4D Guidance System, engineered mesh upper for support',
        brand: 'ASICS', category: 'FOOTWEAR', subCategory: 'RUNNING_SHOES',
        color: 'French Blue/Electric Lime', colorCode: 'FBEL',
        imageUrl: 'https://picsum.photos/seed/asics-kayano30/600/600',
        sourceUrl: 'https://www.mapclub.com/item/asics-store/asics/asics-gel-kayano-30-french-blue-SP261007414929-A065',
        purchasePrice: 1800000, sellingPrice: 2799000, retailer: 'ASICS Store', tags: 'PREMIUM,BEST_SELLER',
        sizes: [{ size: '40', sizeCode: '40' }, { size: '42', sizeCode: '42' }, { size: '44', sizeCode: '44' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── FOOTWEAR / HOKA ──────────────────────────────────────────────────
      {
        genericArticleCode: 'SP261107414929-A066',
        productName: 'HOKA Clifton 9',
        description: 'HOKA Clifton 9 — signature max-cushion road running shoe, compression-molded EVA midsole, early Meta-Rocker for smooth ride',
        brand: 'HOKA', category: 'FOOTWEAR', subCategory: 'RUNNING_SHOES',
        color: 'Blue Graphite/Evening Primrose', colorCode: 'BGEP',
        imageUrl: 'https://picsum.photos/seed/hoka-clifton9/600/600',
        sourceUrl: 'https://www.mapclub.com/item/hoka-store/hoka/hoka-clifton-9-blue-graphite-SP261107414929-A066',
        purchasePrice: 1600000, sellingPrice: 2499000, retailer: 'HOKA Store', tags: 'PREMIUM,NEW_ARRIVAL',
        sizes: [{ size: '40', sizeCode: '40' }, { size: '42', sizeCode: '42' }, { size: '44', sizeCode: '44' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── FOOTWEAR / Skechers ──────────────────────────────────────────────
      {
        genericArticleCode: 'SP261207414929-A067',
        productName: 'Skechers GO WALK 6',
        description: 'Skechers GO WALK 6 — ultra-cushioned walking shoe with Air-Cooled Goga Mat insole, ULTRA GO cushioning, mesh upper for breathability',
        brand: 'Skechers', category: 'FOOTWEAR', subCategory: 'WALKING_SHOES',
        color: 'Black', colorCode: 'BLK',
        imageUrl: 'https://picsum.photos/seed/skechers-gowalk6/600/600',
        sourceUrl: 'https://www.mapclub.com/item/skechers-store/skechers/skechers-go-walk-6-black-SP261207414929-A067',
        purchasePrice: 600000, sellingPrice: 999000, retailer: 'Skechers Store', tags: 'NEW_ARRIVAL',
        sizes: [{ size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── FOOTWEAR / Timberland ────────────────────────────────────────────
      {
        genericArticleCode: 'SP261307414929-A068',
        productName: 'Timberland 6-Inch Premium Boot',
        description: 'Timberland 6-Inch Premium Boot — the iconic waterproof boot, premium full-grain waterproof leather, seam-sealed construction, anti-fatigue footbed',
        brand: 'Timberland', category: 'FOOTWEAR', subCategory: 'BOOTS',
        color: 'Wheat', colorCode: 'WHT',
        imageUrl: 'https://picsum.photos/seed/timberland-6inch/600/600',
        sourceUrl: 'https://www.mapclub.com/item/timberland-store/timberland/timberland-6-inch-premium-boot-wheat-SP261307414929-A068',
        purchasePrice: 1900000, sellingPrice: 3199000, retailer: 'Timberland Store', tags: 'PREMIUM,EXCLUSIVE',
        sizes: [{ size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }, { size: '42', sizeCode: '42' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── FOOTWEAR / Reebok ────────────────────────────────────────────────
      {
        genericArticleCode: 'SP261407414929-A069',
        productName: 'Reebok Classic Leather',
        description: 'Reebok Classic Leather — timeless heritage sneaker, soft garment leather upper, die-cut EVA midsole, high-abrasion rubber outsole',
        brand: 'Reebok', category: 'FOOTWEAR', subCategory: 'CASUAL_SNEAKERS',
        color: 'White/Gum', colorCode: 'WHTGM',
        imageUrl: 'https://picsum.photos/seed/reebok-classic-lthr/600/600',
        sourceUrl: 'https://www.mapclub.com/item/reebok-store/reebok/reebok-classic-leather-white-gum-SP261407414929-A069',
        purchasePrice: 500000, sellingPrice: 899000, retailer: 'Reebok Store', tags: 'BEST_SELLER',
        sizes: [{ size: '39', sizeCode: '39' }, { size: '40', sizeCode: '40' }, { size: '41', sizeCode: '41' }],
        status: 'ACTIVE', companyCode: 'MAPA',
      },
      // ── APPAREL / The North Face ─────────────────────────────────────────
      {
        genericArticleCode: 'SP261507414929-A070',
        productName: 'The North Face ThermoBall Eco Jacket',
        description: 'TNF ThermoBall Eco — sustainable insulation jacket for outdoor adventure, synthetic ThermoBall Eco insulation, water-resistant shell, packable design',
        brand: 'The North Face', category: 'APPAREL', subCategory: 'JACKETS',
        color: 'TNF Black', colorCode: 'TNFBLK',
        imageUrl: 'https://picsum.photos/seed/tnf-thermoball/600/600',
        sourceUrl: 'https://www.mapclub.com/item/the-north-face-store/the-north-face/tnf-thermoball-eco-jacket-black-SP261507414929-A070',
        purchasePrice: 1800000, sellingPrice: 2999000, retailer: 'The North Face Store', tags: 'PREMIUM,FEATURED',
        sizes: [{ size: 'S', sizeCode: 'S' }, { size: 'M', sizeCode: 'M' }, { size: 'L', sizeCode: 'L' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── APPAREL / Levi's ─────────────────────────────────────────────────
      {
        genericArticleCode: 'SP261607414929-A071',
        productName: "Levi's 501 Original Fit Jeans",
        description: "Levi's 501 — the original blue jean since 1873, button fly, straight leg, sits at waist, 100% cotton denim",
        brand: "Levi's", category: 'APPAREL', subCategory: 'PANTS',
        color: 'Medium Stonewash', colorCode: 'MSTW',
        imageUrl: 'https://picsum.photos/seed/levis-501-stonewash/600/600',
        sourceUrl: 'https://www.mapclub.com/item/levis-store/levis/levis-501-original-fit-jeans-stonewash-SP261607414929-A071',
        purchasePrice: 650000, sellingPrice: 1099000, retailer: "Levi's Store", tags: 'BEST_SELLER',
        sizes: [{ size: '30', sizeCode: '30' }, { size: '32', sizeCode: '32' }, { size: '34', sizeCode: '34' }, { size: '36', sizeCode: '36' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── APPAREL / Tommy Hilfiger ─────────────────────────────────────────
      {
        genericArticleCode: 'SP261707414929-A072',
        productName: 'Tommy Hilfiger Classic Polo',
        description: 'Tommy Hilfiger Classic Polo — timeless preppy style, cotton pique fabric, embroidered flag logo on chest, ribbed collar and cuffs',
        brand: 'Tommy Hilfiger', category: 'APPAREL', subCategory: 'T_SHIRTS',
        color: 'Navy', colorCode: 'NAV',
        imageUrl: 'https://picsum.photos/seed/tommy-polo-navy/600/600',
        sourceUrl: 'https://www.mapclub.com/item/tommy-hilfiger-store/tommy-hilfiger/tommy-hilfiger-classic-polo-navy-SP261707414929-A072',
        purchasePrice: 550000, sellingPrice: 899000, retailer: 'Tommy Hilfiger Store', tags: 'PREMIUM',
        sizes: [{ size: 'M', sizeCode: 'M' }, { size: 'L', sizeCode: 'L' }, { size: 'XL', sizeCode: 'XL' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── APPAREL / Nike T-Shirt ───────────────────────────────────────────
      {
        genericArticleCode: 'SP260407414936-A073',
        productName: 'Nike Dri-FIT Miler Running Tee',
        description: 'Nike Dri-FIT Miler running tee with moisture-wicking fabric, mesh panels for ventilation, reflective elements for visibility',
        brand: 'Nike', category: 'APPAREL', subCategory: 'T_SHIRTS',
        color: 'Black', colorCode: 'BLK',
        imageUrl: 'https://picsum.photos/seed/nike-dri-fit-miler/600/600',
        sourceUrl: 'https://www.mapclub.com/item/planet-sports/nike/nike-dri-fit-miler-running-tee-black-SP260407414936-A073',
        purchasePrice: 280000, sellingPrice: 449000, retailer: 'Planet Sports', tags: 'BEST_SELLER',
        sizes: [{ size: 'S', sizeCode: 'S' }, { size: 'M', sizeCode: 'M' }, { size: 'L', sizeCode: 'L' }, { size: 'XL', sizeCode: 'XL' }],
        status: 'ACTIVE', companyCode: 'MAPA',
      },
      // ── APPAREL / Adidas Jacket (IN_REVIEW) ──────────────────────────────
      {
        genericArticleCode: 'SP260507414933-A074',
        productName: 'Adidas Tiro 23 Track Jacket',
        description: 'Adidas Tiro 23 — the ultimate football warm-up jacket, AEROREADY moisture management, full zip with stand-up collar, zip pockets',
        brand: 'Adidas', category: 'APPAREL', subCategory: 'JACKETS',
        color: 'Black/White', colorCode: 'BLKWHT',
        imageUrl: 'https://picsum.photos/seed/adidas-tiro23-jacket/600/600',
        sourceUrl: 'https://www.mapclub.com/item/adidas-originals/adidas/adidas-tiro-23-track-jacket-black-white-SP260507414933-A074',
        purchasePrice: 750000, sellingPrice: 1299000, retailer: 'Adidas Originals', tags: 'NEW_ARRIVAL',
        sizes: [{ size: 'M', sizeCode: 'M' }, { size: 'L', sizeCode: 'L' }, { size: 'XL', sizeCode: 'XL' }],
        status: 'IN_REVIEW', companyCode: 'MAPA',
      },
      // ── APPAREL / Nike Hoodie ────────────────────────────────────────────
      {
        genericArticleCode: 'SP260407414937-A075',
        productName: 'Nike Sportswear Club Fleece Hoodie',
        description: 'Nike Club Fleece Hoodie — soft, warm, and versatile, brushed fleece interior, adjustable hood, kangaroo pocket',
        brand: 'Nike', category: 'APPAREL', subCategory: 'HOODIES',
        color: 'Grey Heather', colorCode: 'GRYHTR',
        imageUrl: 'https://picsum.photos/seed/nike-club-hoodie/600/600',
        sourceUrl: 'https://www.mapclub.com/item/nike-store/nike/nike-sportswear-club-fleece-hoodie-grey-SP260407414937-A075',
        purchasePrice: 450000, sellingPrice: 749000, retailer: 'Nike Store', tags: 'BEST_SELLER',
        sizes: [{ size: 'S', sizeCode: 'S' }, { size: 'M', sizeCode: 'M' }, { size: 'L', sizeCode: 'L' }, { size: 'XL', sizeCode: 'XL' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── ACCESSORIES / Nike Bag ───────────────────────────────────────────
      {
        genericArticleCode: 'SP260407414938-A076',
        productName: 'Nike Brasilia Training Duffel Bag',
        description: 'Nike Brasilia Training Duffel Bag — spacious main compartment, ventilated shoe compartment, multiple zip pockets, adjustable shoulder strap',
        brand: 'Nike', category: 'ACCESSORIES', subCategory: 'BAGS',
        color: 'Black', colorCode: 'BLK',
        imageUrl: 'https://picsum.photos/seed/nike-brasilia-bag/600/600',
        sourceUrl: 'https://www.mapclub.com/item/nike-store/nike/nike-brasilia-training-duffel-bag-black-SP260407414938-A076',
        purchasePrice: 380000, sellingPrice: 599000, retailer: 'Nike Store', tags: 'FEATURED',
        sizes: [{ size: 'M', sizeCode: 'M' }, { size: 'L', sizeCode: 'L' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
      // ── ACCESSORIES / The North Face Backpack ────────────────────────────
      {
        genericArticleCode: 'SP261507414930-A077',
        productName: 'The North Face Borealis Backpack',
        description: 'TNF Borealis Backpack — 28L capacity, FlexVent suspension system, padded laptop sleeve, reflective details, water-repellent finish',
        brand: 'The North Face', category: 'ACCESSORIES', subCategory: 'BAGS',
        color: 'TNF Black', colorCode: 'TNFBLK',
        imageUrl: 'https://picsum.photos/seed/tnf-borealis-bp/600/600',
        sourceUrl: 'https://www.mapclub.com/item/the-north-face-store/the-north-face/tnf-borealis-backpack-black-SP261507414930-A077',
        purchasePrice: 1100000, sellingPrice: 1799000, retailer: 'The North Face Store', tags: 'BEST_SELLER',
        sizes: [{ size: 'S', sizeCode: 'S' }, { size: 'M', sizeCode: 'M' }],
        status: 'ACTIVE', companyCode: 'MAPI',
      },
    ];

    // Expand product groups into individual article records (each size = one record)
    const articleRecords = articleProductGroups.flatMap(group => {
      const compId = group.companyCode === 'MAPA' ? companyMAPA!.id
        : group.companyCode === 'MBA' ? companyMBA!.id
        : companyMAPI!.id;
      return group.sizes.map(s => ({
        payload: {
          article_code: `${group.genericArticleCode}-${s.sizeCode}`,
          articleCode: `${group.genericArticleCode}-${s.sizeCode}`,
          genericArticleCode: group.genericArticleCode,
          article_name: group.productName,
          ...
          selling_price: group.sellingPrice,
          tags: group.tags,
          is_active: true,
    ...
    await createRecordsWithAudit('ARTICLE_MASTER', articleRecords);
    ...
    await createRecordsWithAudit('BRAND_MASTER', [
      ...
      { payload: { brand_code: 'BRD-017', brand_name: 'Skechers', brand_origin: 'USA', parent_company: 'Skechers USA Inc.', category: 'Footwear, Apparel', website: 'https://www.skechers.com', description: 'American footwear brand known for lifestyle and performance shoes' }, status: 'ACTIVE' },
      { payload: { brand_code: 'BRD-018', brand_name: 'Asics', brand_origin: 'Japan', parent_company: 'Asics Corporation', category: 'Footwear, Apparel', website: 'https://www.asics.com', description: 'Japanese multinational sportswear corporation specializing in running' }, status: 'ACTIVE' },
      { payload: { brand_code: 'BRD-019', brand_name: 'Reebok', brand_origin: 'USA', parent_company: 'Authentic Brands Group', category: 'Footwear, Apparel', website: 'https://www.reebok.com', description: 'American fitness footwear and apparel brand' }, status: 'ACTIVE' },
      { payload: { brand_code: 'BRD-020', brand_name: 'Hoka', brand_origin: 'France', parent_company: 'Deckers Brands', category: 'Footwear', website: 'https://www.hoka.com', description: 'French running shoe brand known for maximal cushioning' }, status: 'ACTIVE' },
      { payload: { brand_code: 'BRD-021', brand_name: 'Casio', brand_origin: 'Japan', parent_company: 'Casio Computer Co. Ltd.', category: 'Watches, Electronics', website: 'https://www.casio.com', description: 'Japanese multinational electronics company, maker of G-Shock watches' }, status: 'ACTIVE' },
      { payload: { brand_code: 'BRD-022', brand_name: 'Columbia', brand_origin: 'USA', parent_company: 'Columbia Sportswear Company', category: 'Apparel, Outdoor', website: 'https://www.columbia.com', description: 'American outdoor and active lifestyle brand' }, status: 'ACTIVE' },
      { payload: { brand_code: 'BRD-023', brand_name: 'Calvin Klein', brand_origin: 'USA', parent_company: 'PVH Corp.', category: 'Apparel, Accessories', website: 'https://www.calvinklein.com', description: 'American premium fashion brand' }, status: 'ACTIVE' },
      { payload: { brand_code: 'BRD-024', brand_name: 'Fila', brand_origin: 'Italy', parent_company: 'Fila Korea', category: 'Footwear, Apparel', website: 'https://www.fila.com', description: 'Italian-Korean sportswear brand' }, status: 'ACTIVE' },
      { payload: { brand_code: 'BRD-025', brand_name: 'Diadora', brand_origin: 'Italy', parent_company: 'Diadora S.p.A.', category: 'Footwear, Apparel', website: 'https://www.diadora.com', description: 'Italian sportswear and footwear brand' }, status: 'ACTIVE' },
    ]);
    ...
    await createRecordsWithAudit('PRICING_MASTER', [
      { payload: { pricing_code: 'PRC-001', article_code: 'SP260407414930-A049-41', generic_article_code: 'SP260407414930-A049', price_type: 'REGULAR', price: 1799000, currency: 'IDR', effective_date: '2024-01-01', expiry_date: '2024-12-31', store_type: 'FLAGSHIP', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-002', article_code: 'SP260407414930-A049-41', generic_article_code: 'SP260407414930-A049', price_type: 'COST', price: 1100000, currency: 'IDR', effective_date: '2024-01-01', expiry_date: '2024-12-31', store_type: 'FLAGSHIP', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-003', article_code: 'SP260407414933-A052-41', generic_article_code: 'SP260407414933-A052', price_type: 'REGULAR', price: 3899000, currency: 'IDR', effective_date: '2024-01-01', expiry_date: '2024-12-31', store_type: 'FLAGSHIP', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-004', article_code: 'SP260407414932-A051-40', generic_article_code: 'SP260407414932-A051', price_type: 'REGULAR', price: 1599000, currency: 'IDR', effective_date: '2024-02-01', expiry_date: '2025-01-31', store_type: 'STANDARD', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-005', article_code: 'SP260507414929-A055-41', generic_article_code: 'SP260507414929-A055', price_type: 'REGULAR', price: 3299000, currency: 'IDR', effective_date: '2024-01-15', expiry_date: '2024-12-31', store_type: 'FLAGSHIP', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-006', article_code: 'SP260507414930-A056-40', generic_article_code: 'SP260507414930-A056', price_type: 'REGULAR', price: 1099000, currency: 'IDR', effective_date: '2024-01-01', expiry_date: '2024-12-31', store_type: 'STANDARD', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-007', article_code: 'SP260707414929-A062-40', generic_article_code: 'SP260707414929-A062', price_type: 'REGULAR', price: 799000, currency: 'IDR', effective_date: '2024-01-01', expiry_date: '2024-12-31', store_type: 'STANDARD', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-008', article_code: 'SP261407414929-A069-40', generic_article_code: 'SP261407414929-A069', price_type: 'REGULAR', price: 899000, currency: 'IDR', effective_date: '2024-03-01', expiry_date: '2025-02-28', store_type: 'STANDARD', region: 'EAST_JAVA', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-009', article_code: 'SP261507414929-A070-M', generic_article_code: 'SP261507414929-A070', price_type: 'REGULAR', price: 2999000, currency: 'IDR', effective_date: '2024-01-01', expiry_date: '2024-12-31', store_type: 'FLAGSHIP', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-010', article_code: 'SP260407414938-A076-M', generic_article_code: 'SP260407414938-A076', price_type: 'REGULAR', price: 599000, currency: 'IDR', effective_date: '2024-01-01', expiry_date: '2024-12-31', store_type: 'STANDARD', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-011', article_code: 'SP260407414930-A049-41', generic_article_code: 'SP260407414930-A049', price_type: 'PROMOTIONAL', price: 1439000, currency: 'IDR', effective_date: '2024-07-01', expiry_date: '2024-07-31', store_type: 'FLAGSHIP', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-012', article_code: 'SP260407414931-A050-40', generic_article_code: 'SP260407414931-A050', price_type: 'WHOLESALE', price: 950000, currency: 'IDR', effective_date: '2024-01-01', expiry_date: '2024-12-31', store_type: 'OUTLET', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-013', article_code: 'SP260407414929-A048-40', generic_article_code: 'SP260407414929-A048', price_type: 'REGULAR', price: 1899000, currency: 'IDR', effective_date: '2024-01-01', expiry_date: '2024-12-31', store_type: 'STANDARD', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-014', article_code: 'SP261307414929-A068-41', generic_article_code: 'SP261307414929-A068', price_type: 'REGULAR', price: 3199000, currency: 'IDR', effective_date: '2024-01-01', expiry_date: '2024-12-31', store_type: 'FLAGSHIP', region: 'JABODETABEK', is_active: true }, status: 'ACTIVE' },
      { payload: { pricing_code: 'PRC-015', article_code: 'SP261507414930-A077-M', generic_article_code: 'SP261507414930-A077', price_type: 'REGULAR', price: 1799000, currency: 'IDR', effective_date: '2024-04-01', expiry_date: '2025-03-31', store_type: 'STANDARD', region: 'JABODETABEK', is_active: true }, status: 'IN_REVIEW' },
    ]);
    ...
    await createRecordsWithAudit('INVENTORY_MASTER', [
      { payload: { inventory_code: 'INV-001', article_code: 'SP260407414930-A049-41', generic_article_code: 'SP260407414930-A049', store_code: 'STR-001', quantity_on_hand: 45, quantity_reserved: 5, quantity_available: 40, reorder_point: 10, last_count_date: '2024-06-01', warehouse_location: 'A-01-01', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-002', article_code: 'SP260407414933-A052-41', generic_article_code: 'SP260407414933-A052', store_code: 'STR-002', quantity_on_hand: 12, quantity_reserved: 2, quantity_available: 10, reorder_point: 5, last_count_date: '2024-06-01', warehouse_location: 'A-02-03', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-003', article_code: 'SP260407414932-A051-40', generic_article_code: 'SP260407414932-A051', store_code: 'STR-001', quantity_on_hand: 30, quantity_reserved: 3, quantity_available: 27, reorder_point: 8, last_count_date: '2024-06-01', warehouse_location: 'A-01-02', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-004', article_code: 'SP260407414931-A050-40', generic_article_code: 'SP260407414931-A050', store_code: 'STR-003', quantity_on_hand: 55, quantity_reserved: 8, quantity_available: 47, reorder_point: 15, last_count_date: '2024-05-28', warehouse_location: 'B-01-01', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-005', article_code: 'SP260507414929-A055-41', generic_article_code: 'SP260507414929-A055', store_code: 'STR-005', quantity_on_hand: 8, quantity_reserved: 1, quantity_available: 7, reorder_point: 5, last_count_date: '2024-06-01', warehouse_location: 'C-02-01', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-006', article_code: 'SP260507414930-A056-40', generic_article_code: 'SP260507414930-A056', store_code: 'STR-004', quantity_on_hand: 22, quantity_reserved: 4, quantity_available: 18, reorder_point: 10, last_count_date: '2024-05-30', warehouse_location: 'A-03-01', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-007', article_code: 'SP260707414929-A062-40', generic_article_code: 'SP260707414929-A062', store_code: 'STR-001', quantity_on_hand: 60, quantity_reserved: 10, quantity_available: 50, reorder_point: 20, last_count_date: '2024-06-01', warehouse_location: 'B-02-02', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-008', article_code: 'SP260807414929-A063-40', generic_article_code: 'SP260807414929-A063', store_code: 'STR-010', quantity_on_hand: 35, quantity_reserved: 5, quantity_available: 30, reorder_point: 12, last_count_date: '2024-05-25', warehouse_location: 'A-01-03', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-009', article_code: 'SP261507414929-A070-M', generic_article_code: 'SP261507414929-A070', store_code: 'STR-001', quantity_on_hand: 5, quantity_reserved: 1, quantity_available: 4, reorder_point: 3, last_count_date: '2024-06-01', warehouse_location: 'C-01-01', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-010', article_code: 'SP261307414929-A068-41', generic_article_code: 'SP261307414929-A068', store_code: 'STR-002', quantity_on_hand: 7, quantity_reserved: 2, quantity_available: 5, reorder_point: 3, last_count_date: '2024-05-20', warehouse_location: 'D-01-01', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-011', article_code: 'SP260407414938-A076-M', generic_article_code: 'SP260407414938-A076', store_code: 'STR-007', quantity_on_hand: 100, quantity_reserved: 15, quantity_available: 85, reorder_point: 30, last_count_date: '2024-06-01', warehouse_location: 'E-01-01', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-012', article_code: 'SP260407414929-A048-40', generic_article_code: 'SP260407414929-A048', store_code: 'STR-011', quantity_on_hand: 25, quantity_reserved: 3, quantity_available: 22, reorder_point: 8, last_count_date: '2024-05-28', warehouse_location: 'A-02-01', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-013', article_code: 'SP260507414932-A058-40', generic_article_code: 'SP260507414932-A058', store_code: 'STR-004', quantity_on_hand: 18, quantity_reserved: 2, quantity_available: 16, reorder_point: 10, last_count_date: '2024-06-01', warehouse_location: 'A-04-01', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-014', article_code: 'SP261407414929-A069-40', generic_article_code: 'SP261407414929-A069', store_code: 'STR-014', quantity_on_hand: 15, quantity_reserved: 2, quantity_available: 13, reorder_point: 5, last_count_date: '2024-05-30', warehouse_location: 'B-01-02', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-015', article_code: 'SP260407414936-A073-M', generic_article_code: 'SP260407414936-A073', store_code: 'STR-001', quantity_on_hand: 80, quantity_reserved: 12, quantity_available: 68, reorder_point: 25, last_count_date: '2024-06-01', warehouse_location: 'B-03-01', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-016', article_code: 'SP260607414929-A059-40', generic_article_code: 'SP260607414929-A059', store_code: 'STR-018', quantity_on_hand: 20, quantity_reserved: 3, quantity_available: 17, reorder_point: 8, last_count_date: '2024-05-25', warehouse_location: 'A-01-04', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-017', article_code: 'SP261507414930-A077-M', generic_article_code: 'SP261507414930-A077', store_code: 'STR-005', quantity_on_hand: 3, quantity_reserved: 1, quantity_available: 2, reorder_point: 5, last_count_date: '2024-06-01', warehouse_location: 'C-03-01', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-018', article_code: 'SP260607414930-A060-40', generic_article_code: 'SP260607414930-A060', store_code: 'STR-010', quantity_on_hand: 28, quantity_reserved: 4, quantity_available: 24, reorder_point: 10, last_count_date: '2024-05-28', warehouse_location: 'A-02-02', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-019', article_code: 'SP261607414929-A071-32', generic_article_code: 'SP261607414929-A071', store_code: 'STR-008', quantity_on_hand: 40, quantity_reserved: 6, quantity_available: 34, reorder_point: 15, last_count_date: '2024-06-01', warehouse_location: 'B-01-03', is_active: true }, status: 'ACTIVE' },
      { payload: { inventory_code: 'INV-020', article_code: 'SP260407414937-A075-M', generic_article_code: 'SP260407414937-A075', store_code: 'STR-006', quantity_on_hand: 50, quantity_reserved: 8, quantity_available: 42, reorder_point: 20, last_count_date: '2024-05-30', warehouse_location: 'A-03-02', is_active: true }, status: 'IN_REVIEW' },
    ]);
    ...
    if (existingTasks === 0) {
      ...
      if (articleMod || storeMod) {
        const tasks = [
          { moduleId: articleMod?.id || '', taskType: 'QUALITY_REVIEW', title: 'Review Puma x AMI Suede XL Data Quality', description: 'Puma x AMI Suede XL (SP260607414931-A061) is in DRAFT status — check completeness before approval', priority: 'HIGH', status: 'PENDING', assignedTo: stewardUser?.id, assignedBy: user.id, dueDate: new Date(now.getTime() + 3 * 24 * 60 * 60 * 1000), context: jsonVal({ genericArticleCode: 'SP260607414931-A061', reason: 'DRAFT record needs quality review' }) },
          { moduleId: articleMod?.id || '', taskType: 'DATA_ENRICHMENT', title: 'Add missing product images for Adidas NMD R1', description: 'Adidas NMD R1 (SP260507414931-A057) missing product images — upload hero and lifestyle shots', priority: 'NORMAL', status: 'IN_PROGRESS', assignedTo: stewardUser?.id, assignedBy: user.id, dueDate: new Date(now.getTime() + 7 * 24 * 60 * 60 * 1000), context: jsonVal({ genericArticleCode: 'SP260507414931-A057', missingFields: ['images'] }) },
          ...
          { moduleId: articleMod?.id || '', taskType: 'QUALITY_REVIEW', title: 'Validate pricing for Adidas Tiro 23 Track Jacket', description: 'Adidas Tiro 23 Track Jacket (SP260507414933-A074) in IN_REVIEW status — validate pricing data before approval', priority: 'NORMAL', status: 'PENDING', assignedTo: stewardUser?.id, assignedBy: user.id, dueDate: new Date(now.getTime() + 5 * 24 * 60 * 60 * 1000), context: jsonVal({ genericArticleCode: 'SP260507414933-A074', status: 'IN_REVIEW' }) },
          { moduleId: articleMod?.id || '', taskType: 'DATA_ENRICHMENT', title: "Enrich brand data for Levi's 501 and Tommy Hilfiger Polo", description: "Levi's 501 (SP261607414929-A071) and Tommy Hilfiger Polo (SP261707414929-A072) need sub_category verification", priority: 'NORMAL', status: 'PENDING', assignedTo: stewardUser?.id, assignedBy: user.id, dueDate: new Date(now.getTime() + 5 * 24 * 60 * 60 * 1000), context: jsonVal({ genericArticleCodes: ['SP261607414929-A071', 'SP261707414929-A072'], missingFields: ['sub_category'] }) },
        ].filter(t => t.moduleId);
